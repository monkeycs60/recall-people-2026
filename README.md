Regarding Guideline 2.1 - Information Needed:
  ...
  2. We use the following providers:
    ...
    - OpenAI GPT Image 2 (openai.com) — AI avatar generation from text descriptions
  3. Data sent to each provider:
    ...
    - OpenAI GPT Image 2: text descriptions (gender, ethnicity, age range) for avatar image generation. No real photos or personal data are sent.
