      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-text-secondary leading-relaxed">
            ...
            AI processes information ephemerally. We don&apos;t own your contacts.
            <span className="block mt-2 font-medium text-text-primary">No cloud. No tracking. No leaks.</span>
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-surface p-8 rounded-2xl border border-border shadow-sm flex flex-col items-center text-center">
            ...
            <p className="text-text-secondary text-sm">Data is sent to LLMs only for processing, then immediately discarded. No training on your data.</p>
          </div>
        </div>
      </div>
    </section>
